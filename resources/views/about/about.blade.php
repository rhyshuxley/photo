        ...
        <div class="container d-flex justify-content-center">
            <div class="row">
                ...
                <div class="col-sm text-left d-flex align-items-center justify-content-center flex-column">
                    ...
                    <p>I currently use a Canon 90D and a mixture of lenses to try to cover a variety of different styles of photos. You can see my gear <a href="/gear">here</a>.</p>
