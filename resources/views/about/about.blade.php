...
@section('content')
    <div class="content">
        <div class="container d-flex justify-content-center">
            <div class="row">
                <div class="col-sm">
                    <img src="{{ url('images/about/me2.jpg') }}" class="mx-auto d-block" style="max-width: 90%" alt="logo">
                </div>
                <div class="col-sm text-left mt-2">
                    <p>Thank you for visiting my website!</p>
                    <p>I am a hobby photographer in Birmingham. I mainly take pictures of landscapes and my cat, Kiki.</p>
                    ...
                    <p>I also dabble in writing music, and enjoy watching rugby.</p>
                </div>
            </div>
        </div>
    </div>
